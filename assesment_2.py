"""this is a python program for a school student details"""
import mysql.connector

mydb = mysql.connector.connect(
    host="localhost", user="root", password="Ramkaja@16", database="assesment2"
)
...
class School:  # Create a class as School
    ...
    def get_school_details(self):  # Create a method school details
        """this is a function for get a school details"""
    ...
    def get_attenance_details(self):  # Create a method attenance details
        """ this is a function for getting attenance details"""
        ...
        while i <= self.student_count:  # using while loop to collect a value from users
            ...
            present_days = int(
                input("Enter Presenting Days:")
            )  # Get a presenting days from users
            amount = present_days * 50  # calculate the amount
            values = (
                roll_no,
                present_days,
                amount,
            )  # values are assingned to a variable
        ...
        School.total_amount = (
            amount * self.student_count
        )  # Here calculate the total amount
    ...
    def get_account_details(self, student_fees):  # Create a another method called account details
        """ this is function for getting account details"""
...
class Teacher(School):  # create a class teacher
    ...
    def get_teachers_details(self):  # Create a method teachers details
        """this function is used for get teachers detail"""
    ...
    def get_salary_details(self):  # Create a another method salary details
        """ this function is used for get a salary details """
        ...
        sqlinsertcmd = (
            "INSERT INTO salary_details(teachers_id,Salary_amount) VALUES(%s,%s)"
        )
...
class LossOfPay:  # Create a another class lossof pay
    """Create a another class lossof pay"""
    ...
    def update_salary_details(self):  # Create a another method salary details
        """ this function is used for update salary detail """
        sql_select_query = "select *from salary_details where teachers_id=111"
        mycursor.execute(sql_select_query)
        fine_amount=self.amount +LossOfPay.student_fine*self.student_count
        calc_result = fine_amount / self.student_count
        mycursor.executemany(
            "UPDATE salary_details SET salary_amount= %s WHERE teachers_id=%s",  # Update the values in a table
    ...
    def get_teachers_lossofpay(self):  # Create a another method of lossofpay
        """ this function is used for get teachers lossofpay """
        ...
        mycursor.executemany(
            "INSERT INTO lossofpay(teachers_id,loss_of_pay,salary_amount) VALUES (%s,%s,%s)",
            sql_query,
        )
        mydb.commit()
...
object_one = School(1)
object_one.get_school_details()
object_one.get_attenance_details()
object_one.get_account_details(500)
objectA = Teacher(2)
